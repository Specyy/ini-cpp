...
namespace inicpp {
    ...
    namespace detail {
        ...
        public:
            ...
            inline pair_type& operator*() const noexcept { return *m_cur; }
            inline pair_type* operator->() const noexcept { return m_cur.operator->(); }
        ...
        public:
            ...
            inline pair_type& operator*() const noexcept { auto tmp = m_it; return (--tmp).operator *(); }
            inline pair_type* operator->() const noexcept { auto tmp = m_it; return (--tmp).operator->(); }
